...
public class MessageSender {
    ...
    public static final String TOPIC_NAME = "payment-required-topic";
    ...
    public void send(Message<?> m) {
        try {
            ...
            ProducerRecord<String, String> record = new ProducerRecord<String, String>("payment-required-topic", jsonMessage);
